...
export class MotoBoyComponent implements OnInit {
  ...
  clientesConcluido = [
    {
      ...
      horario: '10h - 11h',
      concluida_em: '1h',
      endereco: 'Rua Chico Mendes N° 14, Centro Sâo Bernardo do Campo - 09784800'
    },
    {
      name: 'Clinica Medica',
      status: 'concluido',
    ...
    },
    {
      ...
      horario: '20h - 21h',
      concluida_em: '6h'  ,
      endereco: 'Rua Chico Mendes soares de alburquerque medeiros silva junior exagerado  N° 14, Centro Sâo Bernardo do Campo - 09784800'
    },
  ];
  horarios = [
  ...
  delivery = {
    ...
    retirada: true,
    frete: 'Ida e Volta',
    endereco_retirada: 'Rua Resende,ua Chico Mendes soares de alburquerque medeiros silva junior exagerado 4, Vila Sao Pedro'
